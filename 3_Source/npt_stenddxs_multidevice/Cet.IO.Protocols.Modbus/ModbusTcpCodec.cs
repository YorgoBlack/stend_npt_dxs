...
namespace Cet.IO.Protocols
{
        ...
        : ModbusCodecBase, IProtocolCodec
    {
        ...
        void IProtocolCodec.ServerEncode(CommDataBase data, ushort clientaddress)
        {
            ...
            writer.WriteByte((byte)clientaddress);
        ...
        CommResponse IProtocolCodec.ServerDecode(CommDataBase data)
        {
            ...
            if (protId != 0) goto LabelIgnore;

            //message length
            var length = incoming.ReadInt16BE();

            if (incoming.Length < (length + 6)) goto LabelUnknown;
